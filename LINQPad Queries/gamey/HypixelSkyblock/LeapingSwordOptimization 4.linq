...
let initialTiers = [ "VII";"V";"VII"]
let initialInventory = 50m * 160m + 64m + 10m
let target = 245760 // cost of leaping sword in eyes
...
let rates =
    [
        {Delay=26m<sec>;Produces=1m;Cost=80m;Tier=1uy}
        // lvl 3
        {Delay=24m<sec>;Produces=1m;Cost=160m + 320m;Tier=3uy}
        // lvl 5
        {Delay=22m<sec>;Produces=1m;Cost=512m + 1280m;Tier=5uy}
        {Delay=20m<sec>;Produces=1m;Cost=3840m + 10240m;Tier=7uy}
        {Delay=17m<sec>;Produces=1m;Cost=20480m + 40960m;Tier=9uy}
        //17m<sec>,81920m
    ]
