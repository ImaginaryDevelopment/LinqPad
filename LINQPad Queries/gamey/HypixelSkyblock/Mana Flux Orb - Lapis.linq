...
// calculate the fastest path to getting e-fermented eyes (based on getting enough lapis only)
...
let initialTiers = [ "VII";"VII"]
let initialInventory = 0m
let target = 102_400 // cost of leaping sword in eyes
...
let rates =
    [
        {Delay=29m<sec>;Produces=6m;Cost=80m;Tier=1uy}
        // lvl 3
        {Delay=27m<sec>;Produces=6m;Cost=160m + 320m;Tier=3uy}
        // lvl 5
        {Delay=25m<sec>;Produces=6m;Cost=512m + 1280m;Tier=5uy}
        {Delay=23m<sec>;Produces=6m;Cost=3840m + 10240m;Tier=7uy}
        {Delay=21m<sec>;Produces=6m;Cost=20480m + 40960m;Tier=9uy}
        //17m<sec>,81920m
        {Delay=18m<sec>;Produces=6m;Cost=204_800m+409_600m;Tier=9uy}
    ]
