...
type Tester() =
    member private __.Prop1 with get() = "Hello Private Property"
    member x.Prop2 = "Hello Public Property"
    member x.GetProp1() = "Hello Method"
    member val Field = "Hello field" with get
...
let testProps = 
    ...
    x?Prop1 |> Dump |> ignore
    x?Prop2 |> Dump |> ignore
    x?GetProp1() |> Dump |> ignore
    x?Field |> Dump |> ignore
//Tester()?Prop1 |> Dump |> ignore


// attempted but failed:
// from http://codebetter.com/matthewpodwysocki/2010/02/05/using-and-abusing-the-f-dynamic-lookup-operator/