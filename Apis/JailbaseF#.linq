...
let getFromApi debug (key:string) source page = 
	...
	let uri = sprintf "https://jailbase-jailbase.p.mashape.com/recent/?source_id=%s%s" source <| kvpOpt "&page" page
	// page=1
	uri.Dump("uri")
...
let typed,raw = 
	// fl-jso, fl-ccso, fl-
	getFromApi false (Util.GetPassword("X-Mashape-Key")) "fl-ccso" <| None // Some 10
